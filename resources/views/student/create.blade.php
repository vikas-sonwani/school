                ...
                <div class="card-body">
                    <div class="row gutters">
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-4 col-12">
                            <div class="form-section-header">Add Student</div>
                        </div>
                        <div class="col-xl-4 mb-2">
                            <div class="field-wrapper">
                                <div class="input-group">
                                    <input class="form-control  @error('enrollment_no') is-invalid @enderror" value="{{ old('enrollment_no') }}" type="text" name="full_name">
                                </div>
                        ...
                        <div class="col-xl-4 mb-2">
                            <div class="field-wrapper">
                                <div class="input-group">
                                    <input class="form-control  @error('roll_no') is-invalid @enderror" value="{{ old('roll_no') }}" type="text" name="full_name">
                                </div>
                                <div class="field-placeholder">Roll Number</div>
                        ...
                        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 mb-3">
                            <div class="field-wrapper">
                                <div class="input-group">
                                    <input class="form-control  @error('father_name') is-invalid @enderror" value="{{ old('father_name') }}" type="text" name="father_name">
                                </div>
                            ...
                            <div class="field-wrapper">
                                <select class="form-select" id="gender" name="gender" required="required">
                                    ...
                                    @foreach ( $gender as $k=>$g )
                                        <option value="{{ $k }}"  {{ (old('full_name')==$k)?'selected':'' }} >{{ $g }}</option>
                                    @endforeach
                                </select>
                        ...
                        <div class="col-xl-4 col-lg-4 col-md-4 col-sm-6 mb-3">
                            <div class="field-wrapper">
                                <div class="input-group">
                                    <input class="form-control  @error('mobile_no') is-invalid @enderror" type="number" maxlength="10" name="mobile_no" value="{{ old('mobile_no') }}">
                                </div>
                        ...
                        <div class="col-xl-4 col-lg-4 col-md-4 col-sm-6 mb-3">
                            <div class="field-wrapper">
                                <div class="input-group">
                                    <input class="form-control  @error('parent_mobile_no') is-invalid @enderror" type="number" maxlength="10" name="parent_mobile_no" value="{{ old('parent_mobile_no') }}">
                                </div>
                        ...
                        <div class="col-xl-4 col-lg-4 col-md-4 col-sm-6 mb-3">
                            <div class="field-wrapper">
                                <div class="input-group">
                                    <input class="form-control  @error('email_id') is-invalid @enderror" type="email" name="email_id" value="{{ old('email_id') }}">
                                </div>
                            ...
                            <div class="field-wrapper">
                                <select class="form-select" id="religion" name="religion" required="required">
                                    ...
                                    @foreach ( $religion as $k=>$g )
                                        <option value="{{ $g->id }}">{{ $g->religion_name }}</option>
                                    @endforeach
                                </select>
                            ...
                            <div class="field-wrapper">
                                <select class="form-select" id="cstate" name="cstate" onchange="getDistrict('cstate','cdistrict')" required="required">
                                    ...
                                    @foreach ( $state as $k=>$st )
                                        <option value="{{ $st->id }}">{{ $st->states_name }}</option>
                                    @endforeach
                                </select>
                        ...
                        <div class="col-xl-4 col-lg-6 col-md-6 col-sm-6 mb-3">
                            <div class="field-wrapper">
                                <div class="input-group">
                                    <input class="form-control  @error('cpincode') is-invalid @enderror" value="{{ old('cpincode')}}" type="number" maxlength="6" name="cpincode">
                                </div>
                        ...
                        <div class="col-xl-4 col-lg-6 col-md-6 col-sm-6 mb-3">
                            <div class="field-wrapper">
                                <div class="input-group">
                                    <input class="form-control  @error('ppincode') is-invalid @enderror" type="number"  maxlength="6" name="ppincode" value="{{ old('ppincode')}}">
                                </div>
                                <div class="field-placeholder">Pincode<span class="text-danger">*</span></div>
                                @error('ppincode') 
                                        <span class="text-danger">{{ $message }}</span>	
