...
<div class="content-wrapper">
            ...
            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="{{ route('admin.all_notification') }}">Member Notification</a></li>
                    </ol>
                </nav>
            </div>
    ...
    <div class="row gutters">
        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
            ...
            <div class="card">
                <div class="card-body">
                    <table id="all_notification" class="table v-middle dataTable no-footer" role="grid" aria-describedby="copy-print-csv_info">
                        <thead>
                            <tr role="row">
                                <th>SNO</th>
                                <th>Notification</th>
    ...
    <script src="{{ asset('vendor/datatables/custom/all_notifications.js') }}"></script>
    @endpush('script')
    @endsection