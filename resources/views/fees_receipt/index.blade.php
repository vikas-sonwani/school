...
<div class="content-wrapper">
            ...
            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="{{ route('fees_receipt.index') }}">Fees Receipt</a></li>
                    </ol>
                </nav>
            </div>
    ...
    <div class="row gutters mb-4">
        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
            <div class="d-flex justify-content-end">
                <a href="{{ route('fees_receipt.create') }}" class="btn btn-info"><i class="icon-plus"></i>Create New Receipt</a>
            </div>
        </div>
    </div>
    ...
    <div class="row gutters">
        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
            ...
            <div class="card">
                <div class="card-body">
                    <table id="fees_receipt" class="table v-middle dataTable no-footer" role="grid" aria-describedby="copy-print-csv_info">
                        <thead>
                            <tr role="row">
                                <th>SNO</th>
                                <th>STUDENT</th>
    ...
    <script src="{{ asset('vendor/datatables/custom/fees_receipt.js') }}"></script>
    @endpush('script')
    @endsection