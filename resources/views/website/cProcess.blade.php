    ...
    <div class="container">
        ...
        <ul class="breadcrumb">
            ...
            <li class="item-current">
                <strong class="bread-link bread-current">Coach Process</strong>
            </li>
        </ul>
    </div>
</div>
                ...
                <div class="col-md-12 col-sm-12">
                    <div class="panel rgb-white-style" style="">
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-md-12">
                                    <iframe src="{{ asset('website/extra-images/Coach (ypl process).pdf')}}" frameborder="0" height="900" width="100%"></iframe>
                                </div>
                            </div>
                        </div>
                    </div>
