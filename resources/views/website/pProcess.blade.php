...
<div class="sub-banner rgb-overlay theme-border">
    <div class="container">
        <h3>Player Process </h3>
        <ul class="breadcrumb">
            <li class="item-home">
                <a class="bread-link bread-home" href="{{ route('website.home') }}" title="Homepage">Home</a>
            </li>
            <li class="item-current">
                <strong class="bread-link bread-current">Player Process</strong>
            </li>
        </ul>
    </div>
</div>
                ...
                <div class="col-md-12 col-sm-12">
                    <div class="panel rgb-white-style" style="">
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-md-12">
                                    <iframe src="{{ asset('website/extra-images/Players(ypl process).pdf')}}" frameborder="0" height="900" width="100%"></iframe>
                                </div>
                            </div>
                        </div>
                    </div>
