...
<div class="content-wrapper">
    ...
    <div class="row gutters">
        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
            ...
            <div class="card">
                <div class="card-body">
                    <table id="fees_category" class="table v-middle dataTable no-footer" role="grid" aria-describedby="copy-print-csv_info">
                        <thead>
                            <tr role="row">
                                <th>SNO</th>
                                <th>LEVEL</th>
    ...
    <script src="{{ asset('vendor/datatables/custom/fees_category.js') }}"></script>
    @endpush('script')
    @endsection