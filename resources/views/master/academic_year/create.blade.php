                ...
                <div class="card-body">
                    <div class="row gutters">
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-4 col-12">
                            <div class="form-section-header">Add Academic Year</div>
                        </div>
                        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 mb-3">
                            <div class="field-wrapper">
                                <div class="input-group">
                                    <input class="form-control  @error('academic_code') is-invalid @enderror" type="text" name="academic_code">
                                </div>
                        ...
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 mb-3">
                            <div class="field-wrapper">
                                <textarea class="form-control  @error('academic_desc') is-invalid @enderror" rows="2" name="academic_desc"></textarea>
